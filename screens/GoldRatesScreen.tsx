...
export default function GoldRatesScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={refreshRates} tintColor="#B8975E" />} contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
