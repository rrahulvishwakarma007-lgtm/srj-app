...
export const products: Product[] = [
  ...
  { id: 2,  name: 'Emerald Cocktail Ring',      category: 'Rings',     price: 198000, weight: 9.1,  purity: '18K', description: '5.2ct Zambian Emerald',       details: 'Statement ring featuring a 5.2 carat Zambian emerald surrounded by brilliant-cut diamonds in 18K gold.',                        icon: 'diamond-outline',  color: '#8C5C2D', image: productImages[12] },
  { id: 3,  name: 'Vintage Signet Ring',        category: 'Rings',     price: 54000,  weight: 8.7,  purity: '22K', description: 'Engraved Family Crest',       details: 'Classic signet ring in 22K gold with hand-engraved family crest motif. A timeless heirloom piece.',                             icon: 'diamond-outline',  color: '#8C5C2D', image: productImages[36] },
  { id: 4,  name: 'Diamond Eternity Band',      category: 'Rings',     price: 87000,  weight: 5.4,  purity: '18K', description: 'Full Eternity Diamond Ring',  details: 'Stunning full eternity band in 18K gold with 24 round brilliant diamonds. Perfect for anniversaries.',                          icon: 'diamond-outline',  color: '#8C5C2D', image: productImages[37] },
  { id: 5,  name: 'Gents Gold Ring',            category: 'Rings',     price: 45000,  weight: 10.2, purity: '22K', description: 'Bold Gents Design 22K',       details: 'Heavy and bold gents ring in 22K gold with traditional engraving. A signature piece for men.',                                  icon: 'diamond-outline',  color: '#8C5C2D', image: productImages[38] },
  { id: 6,  name: 'Kundan Bridal Ring',         category: 'Rings',     price: 67000,  weight: 7.8,  purity: '22K', description: 'Kundan & Meenakari Work',     details: 'Exquisite bridal ring with intricate Kundan setting and colorful Meenakari enamel work on reverse.',                            icon: 'diamond-outline',  color: '#8C5C2D', image: productImages[39] },
