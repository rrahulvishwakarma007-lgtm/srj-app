...
export default function App() {
  ...
  // Intro Screen — keep exact same design/colors, only safe area wrapper added
  if (showIntro) {
    return (
      <SafeAreaProvider>
        <SafeAreaView style={{ flex: 1, backgroundColor: '#2A1B4D' }} edges={['top', 'bottom']}>
          <View style={{ flex: 1, backgroundColor: '#2A1B4D' }}>
            ...
            <StatusBar style="light" backgroundColor="#2A1B4D" />
          </View>
        </SafeAreaView>
      </SafeAreaProvider>
    );
  ...
  // Main App — SafeAreaProvider at root, SafeAreaView respects top+bottom insets
  return (
    <SafeAreaProvider>
